...
class CI_Memcached	{
	 ...
	 * @param	mixed	$value
	 */
	protected function append_or_add($key, $value) {
		return $this->m->append( $key, $value ) or $this->m->add( $key, $value, $this->config['expiration'] ) or $this->m->append_or_add( $key, $value );
	}
